...
import com.meroapp.stayhome.fragments.CovidUpdateFragment;
import com.meroapp.stayhome.fragments.HomeFragment;
import com.meroapp.stayhome.fragments.MyShopFragment;
import com.meroapp.stayhome.fragments.SettingFragment;
                ...
                documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                        try{
                            ...
                            navHeader.setVisibility(View.GONE);
                            nav_menu.findItem(R.id.nav_bar_login_frag).setVisible(false);
                            Log.d(TAG, "onEvent: failed to get nav bar items.");
                        }
                    }
                });
